      ...
      <div class="row">
          <div class="col-md-12">
              ...
              <div class="card-header">
                ...
                <div class="card-body">
                <form class="" method="post" id="myForm" action="{{route('employee.update',$editData->id)}}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                         ...
                         <div class="form-group col-md-4">
                           ...
                           <div class="form-group col-md-4">
                            ...
                            <input type="text" name="github" value="{{$editData->github}}" class="form-control">
                           </div>
                            <div class ="form-group col-md-4">
                          ...
                          <div class ="form-group col-md-4">
                            <img id = "showImage" src ="{{(!empty($editData->image))?url('public/upload/employee_images/'.$editData->image):url('public/upload/no_images.png')}}" style="width:150px; height:160px; border:1px solid #ddd" style="width:150px; height:160px; border:1px solid #ddd"/>
                       </div>
